...
function PrivacyContent() {
  return <>
    ...
    <Section id="privacy-5" title="5. Finalidades e bases legais"><div className="legal-table-wrap"><table className="legal-table"><thead><tr><th>Finalidade</th><th>Dados principais</th><th>Base jurídica possível</th></tr></thead><tbody><tr><td>Criar conta, workspace e executar funções solicitadas</td><td>Cadastro, perfil, empresa e conteúdo</td><td>Execução de contrato ou procedimentos preliminares</td></tr><tr><td>Autenticar, controlar acesso e prevenir abuso</td><td>Credenciais protegidas, sessão, tentativas e auditoria</td><td>Execução do serviço e legítimo interesse em segurança</td></tr><tr><td>Enviar convites, confirmações e lembretes</td><td>Nome, e-mail e dados da reunião</td><td>Execução do serviço solicitado pela organização</td></tr><tr><td>Cumprir deveres legais e responder autoridades</td><td>Registros pertinentes ao pedido</td><td>Cumprimento de obrigação legal ou exercício de direitos</td></tr><tr><td>Tratar foto e mídia opcional</td><td>Arquivo escolhido pelo usuário</td><td>Execução da funcionalidade e escolha ativa do usuário</td></tr></tbody></table></div><p>A base aplicável pode variar conforme o papel exercido e o contexto. O aceite contratual dos documentos não transforma todo tratamento em consentimento.</p></Section>
